    ...
    <div className="min-h-dvh flex items-center justify-center px-6 py-12 bg-[#0A0A0F]">
      <div className="w-full max-w-[400px] animate-fade-up">
        ...
        <div className="text-center mb-10">
          ...
          <h1 className="text-2xl font-bold text-white mb-1">Join PartApp</h1>
          <p className="text-[#6B6B80] text-sm">Start tracking your fitness journey</p>
        </div>

        {/* Form */}
        <form onSubmit={handleSignup} className="space-y-5">
          <div className="space-y-2">
            <Label htmlFor="name" className="text-sm text-[#A0A0B0]">
              Full Name
            </Label>
        ...
        <p className="text-center text-sm text-[#6B6B80] mt-8">
          ...
          <Link href="/login" className="text-[#0057FF] hover:text-[#6292FF] font-medium transition-colors">
            Sign in
          </Link>
        </p>
      </div>
